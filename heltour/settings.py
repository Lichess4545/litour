...
BROKER_URL = env('BROKER_URL', default=f'redis://{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB + 1}')
CELERYBEAT_SCHEDULE = {
...
LOGGING = {
    ...
    'handlers': {
        'default': {
            ...
            'filename': env('LOG_FILE', default=os.path.join(BASE_DIR, 'logs', 'all.log')),
...
log_dir = os.path.dirname(env('LOG_FILE', default=os.path.join(BASE_DIR, 'logs', 'all.log')))

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["bracket", "round_number", "original_pairing_order"],
                        name="tournament__bracket_8cd711_idx",
                    ),
                    models.Index(
                        fields=["bracket", "round_number", "matches_completed"],
                        name="tournament__bracket_bb09ff_idx",
                    ),
                ],

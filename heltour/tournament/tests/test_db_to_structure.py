...
from heltour.tournament.models import (
    League, Season, Round, Team, Player, SeasonPlayer,
    TeamPairing, TeamPlayerPairing, LonePlayerPairing, TeamMember,
)
...
class DbToStructureTests(TestCase):
    ...
    def test_result_to_game_result(self):
        ...
        # Colors reversed
        self.assertEqual(_result_to_game_result('1-0', colors_reversed=True), GameResult.P2_WIN)
        self.assertEqual(_result_to_game_result('0-1', colors_reversed=True), GameResult.P1_WIN)
        self.assertEqual(_result_to_game_result('1/2-1/2', colors_reversed=True), GameResult.DRAW)
        self.assertEqual(_result_to_game_result('1X-0F', colors_reversed=True), GameResult.P2_FORFEIT_WIN)
        self.assertEqual(_result_to_game_result('0F-1X', colors_reversed=True), GameResult.P1_FORFEIT_WIN)

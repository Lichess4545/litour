...
class InviteCodeFormTestCase(TestCase):
    ...
    def test_friends_avoid_fields_hidden_for_invite_only(self):
        ...
        self.assertEqual(form.fields['friends'].widget.__class__.__name__, 'HiddenInput')
    ...
    def test_alternate_preference_hidden_for_invite_only(self):
        ...
        self.assertEqual(form.fields['alternate_preference'].widget.__class__.__name__, 'HiddenInput')

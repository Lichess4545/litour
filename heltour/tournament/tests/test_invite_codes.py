...
class InviteCodeTestCase(TestCase):
    ...
    def test_cannot_reuse_invite_code(self):
        ...
        # Mark it as used
        first_player = Player.objects.create(lichess_username='firstplayer', rating=1500)
        captain_code.mark_used(first_player)
        
        # Try to use it again
        second_player = Player.objects.create(lichess_username='secondplayer', rating=1550)
    ...
    def test_invite_code_case_insensitive(self):
        ...
        found_code = InviteCode.get_by_code('chess-knight-abc123', self.league, self.season)

...
class PureTournamentStructureTest(TestCase):
    ...
    def test_color_alternation_in_team_matches(self):
        ...
        self.assertEqual(
            match.games[0].player1.player_id, builder.metadata.players["W1"]
        )
        self.assertEqual(
            match.games[0].player2.player_id, builder.metadata.players["B1"]
        )
        self.assertEqual(match.games[0].result, GameResult.P1_WIN)

        # Board 2 (index 1): Black Team gets white (colors swapped)
        self.assertEqual(
            match.games[1].player1.player_id, builder.metadata.players["B2"]
        )
        self.assertEqual(
            match.games[1].player2.player_id, builder.metadata.players["W2"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            match.games[2].player1.player_id, builder.metadata.players["W3"]
        )
        self.assertEqual(
            match.games[2].player2.player_id, builder.metadata.players["B3"]
        )
        self.assertEqual(match.games[2].result, GameResult.P1_WIN)

        # Board 4 (index 3): Black Team gets white (colors swapped)
        self.assertEqual(
            match.games[3].player1.player_id, builder.metadata.players["B4"]
        )
        self.assertEqual(
            match.games[3].player2.player_id, builder.metadata.players["W4"]
        )
        self.assertEqual(

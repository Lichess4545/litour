                ...
                if background:
                    ...
                    try:
                        ...
                        if auto_assign_forfeits:
                            forfeit_count = pairinggen.assign_automatic_forfeits(
                                round_to_open
                            )
                            if forfeit_count > 0:
                                msg_list.append(
                        ...
                        with reversion.create_revision():
                            ...
                            if forfeit_count > 0:
                                comment += (
                                    f" Assigned {forfeit_count} automatic forfeits."
                                )
                        ...
                        if publish_immediately:
                            msg_list.append(
                                ("Pairings generated and published.", messages.INFO)
                            )
                        else:
    ...
    def approve_reg(
        ...
        with reversion.create_revision():
            ...
            player, _ = Player.objects.update_or_create(
                lichess_username__iexact=reg.lichess_username, defaults=player_defaults
            )
